...
function mostrarAlerta(mensaje) {
    ...
    if(!existeAlerta) {
        ...
        alerta.classList.add('bg-red-100', 'border-red-400', 'txt-red-700', 'px-4', 'py-3', 'rounded', 'max-w-lg', 'mx-auto', 'mt-6', 'text-center');
...
function buscarImagenes() {
    ...
    const key = '22854412-cdc81795166f61021d0f9320c';
